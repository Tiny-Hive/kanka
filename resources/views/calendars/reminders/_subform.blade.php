    ...
    <div id="entity-calendar-modal-add">
        <x-forms.field
            ...
            <p class="length-warning hidden text-error-content">
                {!!  __('calendars.warnings.event_length', ['documentation' => '<a target="_blank" href="https://docs.kanka.io/en/latest/entries/calendars.html#long-lasting-reminders"><i class="fa-solid fa-external-link" aria-hidden="true"></i> ' . __('footer.documentation') . '</a>'])!!}
            </p>
        </x-forms.field>
</div>
