...
class ColumnDefinitionService
{
    ...
    protected function attributeTemplate(): array
    {
        return [
            ...
            ['key' => 'is_enabled', 'type' => 'icon', 'label' => __('attribute_templates.fields.is_enabled'), 'sortable' => true, 'icon' => 'fa-solid fa-wand-magic', 'tooltip' => __('attribute_templates.fields.is_enabled')],
    ...
    protected function tag(): array
    {
        return [
            ...
            ['key' => 'is_auto_applied', 'type' => 'icon', 'label' => __('attribute_templates.fields.auto_apply'), 'sortable' => true, 'icon' => 'fa-solid fa-wand-magic', 'tooltip' => __('tags.fields.is_auto_applied')],
            ['key' => 'is_hidden', 'type' => 'icon', 'label' => __('campaigns.privacy.hidden'), 'sortable' => true, 'icon' => 'fa-solid fa-eye-slash', 'tooltip' => __('tags.fields.is_hidden')],
            ['key' => 'tags', 'type' => 'tags', 'label' => __('entities.tags'), 'sortable' => true],
            ['key' => 'is_private', 'type' => 'private', 'label' => __('crud.fields.is_private'), 'sortable' => true, 'adminOnly' => true],
        ];
    }
