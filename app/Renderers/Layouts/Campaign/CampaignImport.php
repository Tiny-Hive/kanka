            ...
            'status' => [
                ...
                'render' => function (\App\Models\CampaignImport $model) {
                    if ($model->status_id === CampaignImportStatus::FAILED) {
                        ...
                        return '<span class="text-success"><i class="fa-solid fa-check-circle" aria-hidden="true"></i> ' . __('campaigns/import.status.finished') . '</span>';
                    ...
                    return '<span class="text-neutral-content"><i class="fa-solid fa-spinner fa-spin" aria-hidden="true"></i> ' . __('campaigns/import.status.running') . '</span>';
                },
            ],
        ];
